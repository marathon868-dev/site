...
// Функция инициализации, которая запустится после полной загрузки страницы
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof supabase === 'undefined') {
        ...
        document.getElementById('postsContainer').innerHTML = 
            '<div class="empty-feed">❌ Ошибка: не удалось загрузить Supabase. Проверьте интернет-соединение и обновите страницу.</div>';
        return;
    }
    
    console.log('Supabase SDK найден');
    ...
    console.log('DOM элементы проверены');
